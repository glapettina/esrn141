...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        2º Tercera TM - Espacio E.V.E.
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">2º Tercera TM - Espacio E.V.E.</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="eve" idCurso=6 periodo="'.$_SESSION['periodo'].'" tabla="segundo" informe="informe-area">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeEve" tabla="segundo" nombreAlumno="'.$value["nombre"].'" idAlumno="'.$value["id"].'" periodo="'.$_SESSION['periodo'].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                             ...
                             echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" tabla="segundo" area="eve" idAlumno="'.$value["id"].'" periodo="'.$_SESSION['periodo'].'"  data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
