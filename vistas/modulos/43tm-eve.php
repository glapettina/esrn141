        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="eve" idCurso=14 periodo="'.$_SESSION['periodo'].'" tabla="cuarto" informe="informe-area">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeEve" tabla="cuarto" nombreAlumno="'.$value["nombre"].'" idAlumno="'.$value["id"].'" periodo="'.$_SESSION['periodo'].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                             ...
                             echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" tabla="cuarto" area="eve" idAlumno="'.$value["id"].'" periodo="'.$_SESSION['periodo'].'"  data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
